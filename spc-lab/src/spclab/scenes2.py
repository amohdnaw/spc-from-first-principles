...
# WERules lived here until 2026-08-28. The arc contract has Level 7 absorb it:
# the Western Electric rules are that level's subject, and a standalone act
# about them left Level 9 citing a scene that belonged to a level which did not
# exist yet. `level07_scene.py` is the replacement; `spclab.evidence` prices the
# rules instead of listing them.
